...
# splitmytrack/
APPS_DIR = ROOT_DIR / "splitmytrack"
env = environ.Env()
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///splitmytrack")
}
...
MIGRATION_MODULES = {"sites": "splitmytrack.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "DIRS": [str(APPS_DIR / "ui" / "templates")],
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "splitmytrack.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""biswaz""", "biswasb007@gmail.com")]
...
ACCOUNT_ADAPTER = "splitmytrack.users.adapters.AccountAdapter"
SOCIALACCOUNT_ADAPTER = "splitmytrack.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
